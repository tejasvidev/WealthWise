...
This document defines the API architecture of WealthWise.

The API acts as the communication boundary between the React frontend and the backend application modules.

The API architecture translates frontend actions into controlled backend operations:
